    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 py-8 w-full">
        ...
        <div class="text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="flex justify-center gap-4">
                ...
                <a href="{{ route('tickets.create') }}" class="px-6 py-3 ui-btn-primary font-semibold rounded-xl text-sm transition">Unggah Resep Sekarang</a>
            </div>
        </div>
        @else
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between gap-6 hover:shadow-md transition">
                ...
                <div class="flex md:flex-col justify-between md:justify-center md:items-end shrink-0 gap-3 pt-4 md:pt-0 border-t md:border-t-0 border-gray-100">
                    ...
                    <a href="{{ route('tickets.show', $p->id) }}" class="px-5 py-2.5 ui-btn-primary font-bold rounded-xl text-xs transition shadow-sm text-center flex items-center justify-center gap-1.5 cursor-pointer">
