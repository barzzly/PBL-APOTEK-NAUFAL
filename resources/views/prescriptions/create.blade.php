...
<body class="bg-bg-body text-text-main font-sans antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 py-8 w-full">
        <div style="max-width: 900px; margin: 0 auto; width: 100%;">
            ...
            <div class="bg-white rounded-3xl overflow-hidden border border-gray-150 shadow-xl">
                <!-- Form Header -->
                <div class="bg-gradient-to-r from-primary to-[#008f45] p-6 text-white">
                ...
                <!-- Form Content -->
                <form action="{{ route('prescriptions.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="patient_name" id="patient_name" value="{{ old('patient_name', auth()->user()->name) }}" required
                                class="w-full border border-gray-250 rounded-lg px-3 py-2 text-sm focus:border-primary focus:ring-4 focus:ring-primary-light outline-none transition"
                        ...
                        <div class="md:col-span-2">
                            <label for="prescription_date" class="text-xs font-semibold text-text-main block mb-2">Tanggal Resep <span class="text-red-500">*</span></label>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div id="drop-zone" class="w-full border-2 border-dashed border-gray-300 hover:border-primary bg-gray-50/50 rounded-2xl p-6 md:p-10 text-center transition cursor-pointer flex flex-col items-center justify-center relative overflow-hidden group">
                                ...
                                <div id="upload-prompt" class="space-y-3 flex flex-col items-center">
                                    <div class="w-16 h-16 rounded-full bg-primary-light text-primary flex items-center justify-center text-2xl group-hover:scale-110 transition shadow-inner">
                                        <i class="fa-solid fa-cloud-arrow-up"></i>
                                    </div>
                                    <div>
                                        <p class="text-sm font-bold text-gray-750">Tarik dan taruh foto resep Anda disini</p>
                                        <p class="text-xs text-gray-400 mt-1">atau klik untuk menelusuri folder komputer Anda</p>
                                    </div>
                                    <span class="px-3 py-1.5 bg-white border border-gray-200 text-[10px] font-bold rounded-lg text-gray-500 uppercase tracking-wider">Format: JPG, JPEG, PNG, GIF (Maks. 2MB)</span>
                                </div>
                                <div id="upload-preview" class="hidden w-full flex flex-col items-center space-y-3">
                                    <div class="w-full max-h-64 rounded-xl overflow-hidden shadow-md bg-white border border-gray-150 p-2">
                        ...
                        <!-- Customer Notes -->
                        <div class="md:col-span-2">
                            <label for="customer_notes" class="text-xs font-semibold text-text-main block mb-2">Detail Keluhan / Catatan Tambahan (Opsional)</label>
                            <textarea name="customer_notes" id="customer_notes" rows="3"
                                class="w-full border border-gray-250 rounded-lg p-3 text-sm focus:border-primary focus:ring-4 focus:ring-primary-light outline-none transition resize-none"
                    ...
                    <div class="pt-4 flex flex-col sm:flex-row gap-3">
                        <a href="{{ route('prescriptions.history') }}" class="w-full sm:w-1/3 text-center px-6 py-3 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition">Batal</a>
