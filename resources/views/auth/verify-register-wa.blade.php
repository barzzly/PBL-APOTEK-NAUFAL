...
<head>
    ...
    <title>Verifikasi OTP Pendaftaran | Apotek Naufal</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-xl shadow-md p-8 sm:p-10">
            <div class="text-center mb-8">
                ...
                <h2 class="text-xl font-bold text-text-main mb-1">Verifikasi Pendaftaran</h2>
                <p class="text-sm text-text-muted">Masukkan 6 digit kode OTP yang dikirim ke WhatsApp Anda</p>
            ...
            <form action="/register/verify" method="POST" class="space-y-5">
                @csrf
                ...
                <button type="submit" class="w-full py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition flex items-center justify-center gap-2">
                    <i class="fa-solid fa-shield-check text-lg"></i> Verifikasi & Daftar
                </button>
            </form>
            ...
            <div class="text-center mt-6 text-sm text-text-muted">
                ...
                <form id="resend-form" action="{{ route('register.resend_otp') }}" method="POST" class="hidden">
                    @csrf
            ...
            <div class="text-center mt-4 text-sm">
                <a href="/register" class="text-primary font-semibold hover:text-primary-dark hover:underline transition flex items-center justify-center gap-1">
