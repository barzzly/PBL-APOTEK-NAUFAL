...
<body class="mesh-bg text-text-main antialiased min-h-screen flex items-center justify-center p-5">
    ...
    <div class="w-full max-w-md bg-white rounded-3xl border border-border-muted p-8 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.03)] flex flex-col justify-center gap-6">
        ...
        <div class="text-center">
            ...
            <h2 class="text-xl font-bold tracking-tight text-gray-900 heading-font">Verifikasi Akun</h2>
        ...
        <form action="/register/verify" method="POST" class="space-y-5">
            ...
            <button type="submit" class="w-full py-3.5 ui-btn-primary font-bold rounded-xl text-xs shadow-md shadow-primary/10 hover:shadow-lg hover:shadow-primary/20 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer">
                <i class="fa-solid fa-shield-check text-sm"></i> Verifikasi & Buat Akun
            </button>
        </form>
        ...
        <div class="space-y-4 pt-4 border-t border-border-muted text-center text-xs">
            ...
            <div>
                <a href="/register" class="text-primary font-bold hover:underline transition flex items-center justify-center gap-1.5 cursor-pointer">
                    <i class="fa-solid fa-arrow-left"></i> Kembali ke Halaman Daftar
                </a>
            </div>
        </div>
