            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-5">
                ...
                <div class="ui-product-card overflow-hidden flex flex-col relative group">
                    ...
                    <div class="p-4 flex flex-col flex-grow text-left">
                        ...
                        @if($medicine->stock > 0)
                            <button onclick="addToCart({{ $medicine->id }})" class="mt-auto w-full py-2 ui-btn-ghost text-xs font-semibold rounded-xl hover:bg-primary hover:text-white transition cursor-pointer">Tambah ke Keranjang</button>
                        @else
