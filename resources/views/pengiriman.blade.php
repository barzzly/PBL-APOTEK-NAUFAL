...
<head>
    ...
    <title>Informasi Pengiriman - Apotek Naufal</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Informasi jangkauan pengiriman obat, estimasi waktu antar, biaya ongkir, dan jam operasional kurir Apotek Naufal.">
...
<body class="bg-bg-body text-text-main font-sans antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 py-8 w-full">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-text-main font-semibold text-xs">Informasi Pengiriman</span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <aside class="lg:col-span-4 sticky top-24 space-y-6 lg:block hidden">
                <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 px-2">Layanan Kurir & Pengantaran</h3>
                    <nav class="space-y-1">
                        <a href="#opsi-pengiriman" class="block px-3 py-2 rounded-xl text-xs font-semibold text-primary bg-primary-light">1. Opsi Pengiriman</a>
                        <a href="#perhitungan-ongkir" class="block px-3 py-2 rounded-xl text-xs font-medium text-text-muted hover:bg-gray-50 hover:text-primary">2. Perhitungan Biaya Ongkir</a>
                        <a href="#jam-operasional" class="block px-3 py-2 rounded-xl text-xs font-medium text-text-muted hover:bg-gray-50 hover:text-primary">3. Jam Operasional Kurir</a>
                        <a href="#pengemasan-aman" class="block px-3 py-2 rounded-xl text-xs font-medium text-text-muted hover:bg-gray-50 hover:text-primary">4. Pengemasan Sediaan Obat</a>
                    </nav>
                </div>
            </aside>
            ...
            <div class="lg:col-span-8 bg-white p-6 md:p-10 rounded-3xl border border-gray-100 shadow-sm space-y-8">
                <div>
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold uppercase tracking-wider mb-3">
                        <i class="fa-solid fa-truck-fast"></i> Pengiriman Obat Cepat & Aman
                    </div>
                    <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 heading-font mb-3">Panduan Ketentuan Pengiriman</h1>
                    <p class="text-sm text-gray-500 leading-relaxed">Apotek Naufal memastikan sediaan farmasi dan pesanan Anda diantarkan dengan standar higienitas tinggi serta tepat waktu.</p>
                </div>

                <div class="space-y-8 text-sm text-gray-600 leading-relaxed">
                    
                    <section id="opsi-pengiriman" class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900 heading-font flex items-center gap-3">
                            <span class="w-8 h-8 rounded-xl bg-primary text-white flex items-center justify-center text-sm font-extrabold shrink-0"><i class="fa-solid fa-truck"></i></span>
                            1. Opsi Pengiriman Delivery & Pickup
                        </h2>
                        <div class="pl-11 space-y-2">
                            <p><strong>• Pengiriman Langsung (Delivery):</strong> Kurir internal / pengantar Apotek Naufal mengantarkan obat langsung ke alamat tinggal / lokasi penerima.</p>
                            <p><strong>• Ambil Sendiri (Pickup):</strong> Pelanggan dapat memesan secara online lalu mengambil paket pesanan di lokasi fisik Apotek Naufal (Jl. Andalas Raya No.125, Padang) tanpa dikenakan biaya ongkir.</p>
                        </div>
                    </section>

                    <section id="perhitungan-ongkir" class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900 heading-font flex items-center gap-3">
                            <span class="w-8 h-8 rounded-xl bg-teal-600 text-white flex items-center justify-center text-sm font-extrabold shrink-0"><i class="fa-solid fa-calculator"></i></span>
                            2. Perhitungan Jarak & Biaya Ongkir
                        </h2>
                        <p class="pl-11">Biaya ongkir dihitung secara transparan dan otomatis oleh sistem pada halaman Checkout berdasarkan koordinat titik lokasi tujuan dari Apotek Naufal.</p>
                    </section>

                    <section id="jam-operasional" class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900 heading-font flex items-center gap-3">
                            <span class="w-8 h-8 rounded-xl bg-blue-600 text-white flex items-center justify-center text-sm font-extrabold shrink-0"><i class="fa-regular fa-clock"></i></span>
                            3. Jam Operasional Pengantaran
                        </h2>
                        <p class="pl-11">Pengiriman kurir dilakukan pada jam operasional apotek <strong>(08:00 - 21:00 WIB)</strong> setiap hari. Pesanan yang masuk & lunas di atas jam 21:00 WIB akan dikirimkan pada sesi pagi keesokan harinya.</p>
                    </section>

                    <section id="pengemasan-aman" class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900 heading-font flex items-center gap-3">
                            <span class="w-8 h-8 rounded-xl bg-indigo-600 text-white flex items-center justify-center text-sm font-extrabold shrink-0"><i class="fa-solid fa-box-archive"></i></span>
                            4. Garansi Pengemasan Privasi & Higienis
                        </h2>
                        <p class="pl-11">Setiap sediaan obat dikemas rapi dengan plastik pelindung kedap udara dan amplop/kemasan tertutup untuk menjaga kualitas fisik obat serta menjamin privasi isi produk Anda.</p>
                    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-10">
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-3">
                        ...
                        <li><a href="{{ route('pengiriman') }}" class="text-sm text-primary font-semibold transition">Pengiriman</a></li>
